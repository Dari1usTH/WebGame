...
function draw() {
  ...
  if (!state.running && !state.gameOver) drawCenterText('Press Space / Click to start');
  if (state.paused) drawCenterText('Paused');
  if (state.gameOver) drawCenterText('Game over! Click to restart');
